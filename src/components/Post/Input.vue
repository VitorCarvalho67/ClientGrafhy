...
export default defineComponent({
    ...
    //     curl --request POST \
    //   --url https://0156-2804-3bb4-13f-8900-5d17-fe3a-3de8-fdf6.ngrok-free.app/comunicado/ \
    ...
    methods: {
        ...
        async criarComunicado() {
            ...
            try {
                const response = await axios.post('https://0156-2804-3bb4-13f-8900-5d17-fe3a-3de8-fdf6.ngrok-free.app/comunicado/', formData, {
                    headers: {
