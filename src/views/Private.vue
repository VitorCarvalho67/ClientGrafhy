...
export default defineComponent({
    ...
    methods: {
        ...
        async sendMessage() {
            try {
                const response = await axios.post(`https://0156-2804-3bb4-13f-8900-5d17-fe3a-3de8-fdf6.ngrok-free.app/message_user/`, {
        ...
        async fetchMessages() {
            try {
                const response = await axios.get(`https://0156-2804-3bb4-13f-8900-5d17-fe3a-3de8-fdf6.ngrok-free.app/message_user/${this.userId}/${this.contactId}`);
        ...
        async fetchLoggedInUserId() {
            try {
                const response = await axios.get(`https://0156-2804-3bb4-13f-8900-5d17-fe3a-3de8-fdf6.ngrok-free.app/users/email/${this.userEmail}`);
