...
export default defineComponent({
    ...
    methods: {
        ...
        async sendMessage() {
            try {
                const response = await axios.post(`https://gafhypy.favela.network/message_user/`, {
        ...
        async fetchMessages() {
            try {
                const response = await axios.get(`https://gafhypy.favela.network/message_user/${this.userId}/${this.contactId}`);
        ...
        async fetchLoggedInUserId() {
            try {
                const response = await axios.get(`https://gafhypy.favela.network/users/email/${this.userEmail}`);
