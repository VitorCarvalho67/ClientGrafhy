...
export default defineComponent({
    ...
    methods: {
        ...
        async sendMessage() {
            try {
                const response = await axios.post(`http://7ef5-2804-3bb4-13f-8900-452b-c950-55a9-4c60.ngrok-free.app/message_user/`, {
        ...
        async fetchMessages() {
            try {
                const response = await axios.get(`http://7ef5-2804-3bb4-13f-8900-452b-c950-55a9-4c60.ngrok-free.app/message_user/${this.userId}/${this.contactId}`);
        ...
        async fetchLoggedInUserId() {
            try {
                const response = await axios.get(`http://7ef5-2804-3bb4-13f-8900-452b-c950-55a9-4c60.ngrok-free.app/users/email/${this.userEmail}`);
